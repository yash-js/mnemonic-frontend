...
function PopoverComponent({btnname, popoverheading, popovercontent, popoverclassname}) {
    ...
    const popoverContent = [
        <span className={`notecontent ${popoverclassname}`}>
            <div className='notetop'>
                <div className='noteheading' style={{display: popoverheading ? 'block' : 'hide'}}>
                ...
                <div className='noteclosebtn'>
                    <IconButton color="primary" aria-label="upload picture" component="label" onClick={handleClose}>
                        <CloseIcon style={{color: 'black', width: '35px', height: '35px'}} />
                    </IconButton>
                </div>
            </div>
    ...
    return (
        <div className="notebtn">
            <IconButton color="primary" aria-label="upload picture" component="label" onClick={handleClick}>
                {btnname ? btnname : <AddIcon style={{color: 'black', width: '40px', height: '40px'}} />}
            </IconButton>
            <Popover
            id={id}
            open={open}
